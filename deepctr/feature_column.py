...
def get_linear_logit(features, feature_columns, untrain_feature_columns, 
                     units=1, use_bias=False, seed=1024, prefix='linear',
                     l2_reg=0):
    ...
    linear_emb_list = [input_from_feature_columns(features, linear_feature_columns, untrain_feature_columns, l2_reg, seed, prefix=prefix + str(i))[0] for i in range(units)]
    _, dense_input_list,_ = input_from_feature_columns(features, linear_feature_columns, untrain_feature_columns, 
                                                     l2_reg, seed, prefix=prefix)
...
def input_from_feature_columns(features, feature_columns, untrain_feature_columns, l2_reg, seed=1024, prefix='', seq_mask_zero=True,
    ...
    group_sparse_embedding_dict, untrain_embedding_dict = embedding_lookup(embedding_matrix_dict, features,
                                                                           sparse_feature_columns, untrain_feature_columns)
    ...
    return group_embedding_dict, dense_value_list, list(chain.from_iterable(untrain_embedding_dict.values()))
