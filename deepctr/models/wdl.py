...
def WDL(linear_feature_columns, dnn_feature_columns, untrain_feature_columns, 
    ...
    sparse_embedding_list, dense_value_list, _ = input_from_feature_columns(features, dnn_feature_columns,
