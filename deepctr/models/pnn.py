...
def PNN(dnn_feature_columns, untrain_feature_columns, dnn_hidden_units=(128, 128), l2_reg_embedding=1e-5, l2_reg_dnn=0,
    ...
    sparse_embedding_list, dense_value_list, _ = input_from_feature_columns(features, dnn_feature_columns, untrain_feature_columns, l2_reg_embedding, seed)
