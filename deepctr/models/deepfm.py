...
def DeepFM(linear_feature_columns, dnn_feature_columns, untrain_feature_columns, 
           fm_group=[DEFAULT_GROUP_NAME], dnn_hidden_units=(128, 128),
    ...
    group_embedding_dict,dense_value_list,_ = input_from_feature_columns(features, dnn_feature_columns, untrain_feature_columns,
